...
#define GPS_UART_TX_BUFFER_SIZE                 (4u)
#define GPS_UART_RX_BUFFER_SIZE                 (4u)
...
#if defined(GPS_UART_BUART_sCR_SyncCtl_CtrlReg__CONTROL_REG)
...
/* Only if RX is enabled */
        ...
        #define GPS_UART_EnableRxInt()  CyIntEnable (GPS_UART_RX_VECT_NUM)
        #define GPS_UART_DisableRxInt() CyIntDisable(GPS_UART_RX_VECT_NUM)
...
/* Only if TX is enabled */
        ...
        #define GPS_UART_EnableTxInt()  CyIntEnable (GPS_UART_TX_VECT_NUM)
        #define GPS_UART_DisableTxInt() CyIntDisable(GPS_UART_TX_VECT_NUM)
        #define GPS_UART_SetPendingTxInt() CyIntSetPending(GPS_UART_TX_VECT_NUM)
        #define GPS_UART_ClearPendingTxInt() CyIntClearPending(GPS_UART_TX_VECT_NUM)
...
/* Communication bootloader APIs */
    ...
    #define GPS_UART_PACKET_EOP         (0x17u) /* End of packet defined by bootloader */
    #define GPS_UART_WAIT_EOP_DELAY     (5u)    /* Additional 5ms to wait for End of packet */
    #define GPS_UART_BL_CHK_DELAY_MS    (1u)    /* Time Out quantity equal 1mS */
...
#define GPS_UART_BIT_CENTER                         (GPS_UART_OVER_SAMPLE_COUNT - 2u)
...
extern uint8 GPS_UART_initVar;
    ...
    extern volatile uint8 GPS_UART_txBuffer[GPS_UART_TX_BUFFER_SIZE];
    ...
    extern uint8 GPS_UART_errorStatus;
    extern volatile uint8 GPS_UART_rxBuffer[GPS_UART_RX_BUFFER_SIZE];
...
#if (GPS_UART_RXHW_ADDRESS_ENABLED)
    #define GPS_UART_RX_ADDRESS_MODE    (0u)
    #define GPS_UART_RX_HW_ADDRESS1     (0u)
    #define GPS_UART_RX_HW_ADDRESS2     (0u)
#endif /* (GPS_UART_RXHW_ADDRESS_ENABLED) */
...
#define GPS_UART_WAIT_1_MS      GPS_UART_BL_CHK_DELAY_MS   

#define GPS_UART_TXBUFFERSIZE   GPS_UART_TX_BUFFER_SIZE
#define GPS_UART_RXBUFFERSIZE   GPS_UART_RX_BUFFER_SIZE

#if (GPS_UART_RXHW_ADDRESS_ENABLED)
    #define GPS_UART_RXADDRESSMODE  GPS_UART_RX_ADDRESS_MODE
    #define GPS_UART_RXHWADDRESS1   GPS_UART_RX_HW_ADDRESS1
    #define GPS_UART_RXHWADDRESS2   GPS_UART_RX_HW_ADDRESS2
